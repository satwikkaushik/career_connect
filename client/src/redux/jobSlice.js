...
const initialState = {
  ...
  jobs: [
    ...
    },
    {
      ...
      eligibility: "Bachelor’s degree in Computer Science or equivalent.",
      responsibilities: [
    ...
    },
    {
      ...
      eligibility: "Bachelor’s degree in Cybersecurity or related field.",
      responsibilities: [
    ...
    },
    {
      ...
      eligibility: "Master’s degree in AI, Machine Learning, or related field.",
      responsibilities: [
...
const jobSlice = createSlice({
  ...
  reducers: {
    ...
    setUserRole: (state, action) => {
      state.userRole = action.payload; // Change role dynamically
    },
