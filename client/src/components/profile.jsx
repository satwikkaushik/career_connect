...
const ProfilePage = () => {
  ...
  const storedName = localStorage.getItem("userName") || "Arpit Kumar Saxena";
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#051923] text-white p-6">
      <div className="bg-[#003554] shadow-lg p-8 rounded-xl w-full max-w-md text-center border border-[#00A6FB]/30">
        ...
        <div className="mt-4">
          ...
          <p className="text-gray-400 font-semibold">Role: {user.role}</p>
        </div>

        {/* Additional User Details */}
        <div className="mt-4 text-left space-y-3">
          <p className="text-gray-300">
            <span className="font-semibold text-white">University Roll No: </span> {user.universityRollNo}
          </p>
          <p className="text-gray-300">
            <span className="font-semibold text-white">Course: </span> {user.course}
          </p>
          <p className="text-gray-300">
            <span className="font-semibold text-white">Branch: </span> {user.branch}
          </p>
          <p className="text-gray-300">
            <span className="font-semibold text-white">Semester: </span> {user.semester}
          </p>
        </div>
        ...
        <div className="mt-6">
          {editMode ? (
            <button onClick={handleSave} className="bg-[#00A6FB] text-white px-6 py-2 rounded-md hover:bg-[#0582CA] transition">
              <Check className="mr-1" /> Save
            </button>
          ) : (
            <button onClick={handleEdit} className="bg-[#00A6FB] text-white px-6 py-2 rounded-md hover:bg-[#0582CA] transition">
